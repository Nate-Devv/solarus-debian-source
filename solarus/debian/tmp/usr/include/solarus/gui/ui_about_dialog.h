...
""));
    ...
    void retranslateUi(QDialog *SolarusGui__AboutDialog)
    {
        ...
        app_title_label->setText(QApplication::translate("SolarusGui::AboutDialog", "Solarus", 0));
        app_version_label->setText(QApplication::translate("SolarusGui::AboutDialog", "1.0.0", 0));
        app_description_label->setText(QApplication::translate("SolarusGui::AboutDialog", "Launcher for Solarus Quests.", 0));
...
"</body></html>", 0));
        app_copyright_label->setText(QApplication::translate("SolarusGui::AboutDialog", "<html><head/><body><p>\302\251 2011-2016 Christopho, Solarus.</p></body></html>", 0));
        app_license_label->setText(QApplication::translate("SolarusGui::AboutDialog", "This program is under <a href=\"http://www.gnu.org/licenses/gpl-3.0.html\">GPL v3 license</a>.", 0));
